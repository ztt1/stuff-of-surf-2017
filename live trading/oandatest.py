...
def parse_args(pargs=None):
    ...
    parser.add_argument('--token', default='2562b18e6d5bece82ef42124905c233e-f6b78e8dddfa7e132edd8a8c24015904',
                         action='store',
                        help='Access token to use')

    parser.add_argument('--account', default='JingjueWei',
                         action='store',
